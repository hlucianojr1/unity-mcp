...
class ServerConfig:
    ...
    # Connection settings
    connection_timeout: float = 10.0  # short initial timeout
    handshake_timeout: float = 10.0  # timeout for Unity handshake negotiation
    buffer_size: int = 16 * 1024 * 1024  # 16MB buffer

    # Framed receive behavior
    framed_receive_timeout: float = 10.0  # max seconds consuming heartbeats only
    max_heartbeat_frames: int = 16  # cap heartbeat frames before giving up
